...
[ExecuteInEditMode]
public class UI3DDepthObject : MonoBehaviour
{
    public const string depthRenderShaderName = "MODev/UI3D/Mask/DepthRender";
    public const string cullRenderShaderName = "MODev/UI3D/Mask/CullRender";
    public UI3DMaskRenderMode renderMode;
    public UI3DMaskSourceMode source;
    public UI3DMaskAlphaMode alphaMode;
    ...
    private UI3DCanvas particleCanvas;
    ...
    {
        RectTrans = GetComponent<RectTransform>();
        particleCanvas = GetComponentInParent<UI3DCanvas>();
    ...
    public void RefreshRenderer(bool recreateRenderer = false, bool afterRetry = false)
    {
        ...
        switch(source)
        {
            case UI3DMaskSourceMode.Image:
                ...
                break;
            case UI3DMaskSourceMode.RawImage:
                ...
                break;
            case UI3DMaskSourceMode.MaskTexture:
    ...
    private void CreateMaskRendererObject(UI3DCanvas particleCanvas)
    {
