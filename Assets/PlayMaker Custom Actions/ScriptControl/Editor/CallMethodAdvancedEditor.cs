...
namespace HutongGames.PlayMakerEditor
{
    ...
    /// </summary>
	[CustomActionEditor(typeof(HutongGames.PlayMaker.Actions.CallMethodAdvanced))]
	public class CallMethodEditorAdvanced : CustomActionEditor
    {
		private CallMethodAdvanced callMethod;
        ...
        {
			callMethod = target as CallMethodAdvanced;
            if (callMethod != null)
            {
